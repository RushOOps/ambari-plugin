...
def dolphin_env():
    ...
    File(format(params.dolphin_conf_dir + "/logback-worker.xml"),
         mode=0755,
         content=Template("logback-worker.xml.j2"),
         owner=params.dolphin_user,
         group=params.dolphin_group
         )

    File(format(params.dolphin_conf_dir + "/logback-master.xml"),
         mode=0755,
         content=Template("logback-master.xml.j2"),
         owner=params.dolphin_user,
         group=params.dolphin_group
         )

    File(format(params.dolphin_conf_dir + "/logback-api.xml"),
         mode=0755,
         content=Template("logback-api.xml.j2"),
         owner=params.dolphin_user,
         group=params.dolphin_group
         )

    File(format(params.dolphin_conf_dir + "/logback-alert.xml"),
         mode=0755,
         content=Template("logback-alert.xml.j2"),
         owner=params.dolphin_user,
         group=params.dolphin_group
         )