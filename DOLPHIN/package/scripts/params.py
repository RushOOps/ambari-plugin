...
#log config content
logback_worker = config['configurations']['dolphin-logback']['logback-worker.xml']
logback_master = config['configurations']['dolphin-logback']['logback-master.xml']
logback_api = config['configurations']['dolphin-logback']['logback-api.xml']
logback_alert = config['configurations']['dolphin-logback']['logback-alert.xml']
...
dolphin_app_api_map = {}
dolphin_app_api_map['logging.config'] = 'classpath:logback-api.xml'
...
dolphin_common_map['resource.storage.type'] = config['configurations']['dolphin-common']['res.upload.startup.type']
